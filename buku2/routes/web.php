...
Route::put('/profil', [App\Http\Controllers\UserPageController::class, 'updateProfile'])->name('profile.update');
...
// Route::post('/user/{id}/changerole', 'UserPageController@changeRole')->name('user.changeRole');

Route::post('/user/{id}/changerole', 'App\Http\Controllers\UserPageController@changeRole')->name('user.changeRole');
...
// edit genre
Route::get('editgenre/{id}', [GenreController::class, 'edit']);
Route::post('updategenre/{id}', [GenreController::class, 'update']);
