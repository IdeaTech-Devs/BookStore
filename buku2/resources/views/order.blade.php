            ...
            <form method="post" action="/insertbuku">
                ...
                <div class="mb-3">  
                    ...
                    <input type="text" name="penulis"class="form-control" @error('penulis') is-invalid @enderror
                        id="penulis" required value="{{ old('penulis') }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="sinopsis"class="form-control" @error('sinopsis') is-invalid @enderror
                        id="sinopsis" required value="{{ old('sinopsis') }}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="jumlah"class="form-control" @error('jumlah') is-invalid @enderror
                        id="jumlah" required value="{{ old('jumlah') }}">
                </div>
                ...
                <form method="post" action="/order">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="sinopsis"class="form-control"
                            @error('sinopsis') is-invalid @enderror id="sinopsis" required
                            value="{{ old('sinopsis') }}">
                    </div>
