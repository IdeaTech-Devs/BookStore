                        ...
                        <form method="post" action="/insertgenre">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="penjelasan"class="form-control"
                                    @error('penjelasan') is-invalid @enderror id="penjelasan" required
                                    value="{{ old('penjelasan') }}">
                            </div>
                ...
                @foreach ($genre as $genre)
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Tambahkan tautan edit di sini -->
                            <a href="{{ url('editgenre/' . $genre->id) }}" class="btn btn-primary btn-sm">Edit</a>
                            <a href="{{ url('insertgenre/' . $genre->id) }}" class="btn btn-danger btn-sm"
